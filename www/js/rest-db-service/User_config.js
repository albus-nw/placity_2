...
angular.module('restDataServices')
    .factory('User_config', User_config);

    User_config.$inject = ['$resource'];
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen User_config
     *
     * @example:
     *  - get:       User_config.get({id:'1',related:'*'})   selectiert User_config mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    User_config.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   User_config.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in User_config.id=1
     *  - update:    User_config.update({id:1,KEY:VALUE})    update von KEY:VALUE in User_config.id=1
     *  - delete:    User_config.remove({id:1})              löscht User_config.id=1
     *               User_config.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function User_config ($resource) {
        return $resource('/api/v2/db/_table/User_config/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             ...
             *
             * @description
             * User_config.get() Datenbank-Selection der Tabelle User_config
             ...
             *
             * @description
             * User_config.create() erstellt eine Instanz des Entity-Typs User_config
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created User_config instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/User_config/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name User_config.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_config.replace() ersetzen von einzelen Feldern einer Instanz des Typs User_config
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name User_config.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_config.update() update von einzelen Feldern einer Instanz des Typs User_config
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @description
             * User_config.remove() löschen einer Instanz des Typs User_config
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
