...
angular.module('restDataServices')
    .factory('Routentag', Routentag);

    Routentag.$inject = ['$resource'];
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen Routentag
     *
     * @example:
     *  - get:       Routentag.get({id:'1',related:'*'})   selectiert Routentag mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    Routentag.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   Routentag.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in Routentag.id=1
     *  - update:    Routentag.update({id:1,KEY:VALUE})    update von KEY:VALUE in Routentag.id=1
     *  - delete:    Routentag.remove({id:1})              löscht Routentag.id=1
     *               Routentag.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function Routentag ($resource) {
        return $resource('/api/v2/_table/Routentag/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name Routentag.get
             ...
             *
             * @description
             * Routentag.get() Datenbank-Selection der Tabelle Routentag
            ...
            /**
             * @ngdoc function
             * @name Routentag.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Routentag.create() erstellt eine Instanz des Entity-Typs Routentag
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created Routentag instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/Routentag/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name Routentag.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Routentag.replace() ersetzen von einzelen Feldern einer Instanz des Typs Routentag
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name Routentag.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Routentag.update() update von einzelen Feldern einer Instanz des Typs Routentag
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name Routentag.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Routentag.remove() löschen einer Instanz des Typs Routentag
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
