...
angular.module('restDataServices')
     ...
     */
        ...
        return $resource('/api/v2/db/_table/Player/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name Player.get
             ...
             *
             * @description
             * Player.get() Datenbank-Selection der Tabelle Player
             ...
             *
             * @description
             * Player.create() erstellt eine Instanz des Entity-Typs Player
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created Player instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/Player/create'
             ...
             *
             * @description
             * Player.replace() ersetzen von einzelen Feldern einer Instanz des Typs Player
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @description
             * Player.update() update von einzelen Feldern einer Instanz des Typs Player
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @description
             * Player.remove() löschen einer Instanz des Typs Player
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
