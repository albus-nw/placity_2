...
angular.module('restDataServices')
    .factory('User_to_app_to_role', User_to_app_to_role);

    User_to_app_to_role.$inject = ['$resource'];

    /* @ngInject */
    /**
     * @ngdoc service
     * @name User_to_app_to_role
     * @requires $resource
     * @requires ngResource
     *
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen User_to_app_to_role
     *
     * @example:
     *  - get:       User_to_app_to_role.get({id:'1',related:'*'})   selectiert User_to_app_to_role mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    User_to_app_to_role.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   User_to_app_to_role.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in User_to_app_to_role.id=1
     *  - update:    User_to_app_to_role.update({id:1,KEY:VALUE})    update von KEY:VALUE in User_to_app_to_role.id=1
     *  - delete:    User_to_app_to_role.remove({id:1})              löscht User_to_app_to_role.id=1
     ...
     */
        ...
        return $resource('/api/v2/_table/User_to_app_to_role/:id', {id: '@id'}, {
             ...
             *
             * @description
             * User_to_app_to_role.get() Datenbank-Selection der Tabelle User_to_app_to_role
            ...
            /**
             * @ngdoc function
             * @name User_to_app_to_role.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_to_app_to_role.create() erstellt eine Instanz des Entity-Typs User_to_app_to_role
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created User_to_app_to_role instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/User_to_app_to_role/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name User_to_app_to_role.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_to_app_to_role.replace() ersetzen von einzelen Feldern einer Instanz des Typs User_to_app_to_role
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name User_to_app_to_role.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_to_app_to_role.update() update von einzelen Feldern einer Instanz des Typs User_to_app_to_role
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name User_to_app_to_role.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_to_app_to_role.remove() löschen einer Instanz des Typs User_to_app_to_role
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            //    return User_to_app_to_role.create();
            //}
        })
    }
