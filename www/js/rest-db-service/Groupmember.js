...
angular.module('restDataServices')
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen Groupmember
     *
     * @example:
     *  - get:       Groupmember.get({id:'1',related:'*'})   selectiert Groupmember mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    Groupmember.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   Groupmember.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in Groupmember.id=1
     *  - update:    Groupmember.update({id:1,KEY:VALUE})    update von KEY:VALUE in Groupmember.id=1
     *  - delete:    Groupmember.remove({id:1})              löscht Groupmember.id=1
     ...
     */
        ...
        return $resource('/api/v2/db/_table/Groupmember/:id', {id: '@id'}, {
             ...
             *
             * @description
             * Groupmember.get() Datenbank-Selection der Tabelle Groupmember
            ...
            /**
             * @ngdoc function
             * @name Groupmember.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Groupmember.create() erstellt eine Instanz des Entity-Typs Groupmember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created Groupmember instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/Groupmember/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name Groupmember.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Groupmember.replace() ersetzen von einzelen Feldern einer Instanz des Typs Groupmember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name Groupmember.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Groupmember.update() update von einzelen Feldern einer Instanz des Typs Groupmember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name Groupmember.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Groupmember.remove() löschen einer Instanz des Typs Groupmember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
