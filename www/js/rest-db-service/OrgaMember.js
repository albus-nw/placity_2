...
angular.module('restDataServices')
    .factory('OrgaMember', OrgaMember);

    OrgaMember.$inject = ['$resource'];
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen OrgaMember
     *
     * @example:
     *  - get:       OrgaMember.get({id:'1',related:'*'})   selectiert OrgaMember mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    OrgaMember.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   OrgaMember.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in OrgaMember.id=1
     *  - update:    OrgaMember.update({id:1,KEY:VALUE})    update von KEY:VALUE in OrgaMember.id=1
     *  - delete:    OrgaMember.remove({id:1})              löscht OrgaMember.id=1
     *               OrgaMember.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function OrgaMember ($resource) {
        return $resource('/api/v2/db/_table/OrgaMember/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name OrgaMember.get
             ...
             *
             * @description
             * OrgaMember.get() Datenbank-Selection der Tabelle OrgaMember
            ...
            /**
             * @ngdoc function
             * @name OrgaMember.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * OrgaMember.create() erstellt eine Instanz des Entity-Typs OrgaMember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created OrgaMember instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/OrgaMember/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name OrgaMember.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * OrgaMember.replace() ersetzen von einzelen Feldern einer Instanz des Typs OrgaMember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name OrgaMember.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * OrgaMember.update() update von einzelen Feldern einer Instanz des Typs OrgaMember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name OrgaMember.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * OrgaMember.remove() löschen einer Instanz des Typs OrgaMember
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
