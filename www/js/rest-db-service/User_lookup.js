...
angular.module('restDataServices')
    .factory('User_lookup', User_lookup);

    User_lookup.$inject = ['$resource'];
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen User_lookup
     *
     * @example:
     *  - get:       User_lookup.get({id:'1',related:'*'})   selectiert User_lookup mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    User_lookup.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   User_lookup.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in User_lookup.id=1
     *  - update:    User_lookup.update({id:1,KEY:VALUE})    update von KEY:VALUE in User_lookup.id=1
     *  - delete:    User_lookup.remove({id:1})              löscht User_lookup.id=1
     *               User_lookup.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function User_lookup ($resource) {
        return $resource('/api/v2/db/_table/User_lookup/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name User_lookup.get
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_lookup.get() Datenbank-Selection der Tabelle User_lookup
            ...
            /**
             * @ngdoc function
             * @name User_lookup.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_lookup.create() erstellt eine Instanz des Entity-Typs User_lookup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created User_lookup instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/User_lookup/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name User_lookup.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_lookup.replace() ersetzen von einzelen Feldern einer Instanz des Typs User_lookup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name User_lookup.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_lookup.update() update von einzelen Feldern einer Instanz des Typs User_lookup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name User_lookup.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * User_lookup.remove() löschen einer Instanz des Typs User_lookup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
