...
angular.module('restDataServices')
    .factory('v_emails_group', v_emails_group);

    v_emails_group.$inject = ['$resource'];
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen v_emails_group
     *
     * @example:
     *  - get:       v_emails_group.get({id:'1',related:'*'})   selectiert v_emails_group mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    v_emails_group.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   v_emails_group.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in v_emails_group.id=1
     *  - update:    v_emails_group.update({id:1,KEY:VALUE})    update von KEY:VALUE in v_emails_group.id=1
     *  - delete:    v_emails_group.remove({id:1})              löscht v_emails_group.id=1
     ...
     */
        ...
        return $resource('/api/v2/_table/v_emails_group/:id', {id: '@id'}, {
             ...
             *
             * @description
             * v_emails_group.get() Datenbank-Selection der Tabelle v_emails_group
            ...
            /**
             * @ngdoc function
             * @name v_emails_group.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_emails_group.create() erstellt eine Instanz des Entity-Typs v_emails_group
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created v_emails_group instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/v_emails_group/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name v_emails_group.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_emails_group.replace() ersetzen von einzelen Feldern einer Instanz des Typs v_emails_group
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name v_emails_group.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_emails_group.update() update von einzelen Feldern einer Instanz des Typs v_emails_group
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name v_emails_group.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_emails_group.remove() löschen einer Instanz des Typs v_emails_group
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
