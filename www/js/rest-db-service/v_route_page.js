...
angular.module('restDataServices')
    .factory('v_route_page', v_route_page);

    v_route_page.$inject = ['$resource'];
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen v_route_page
     *
     * @example:
     *  - get:       v_route_page.get({id:'1',related:'*'})   selectiert v_route_page mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    v_route_page.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   v_route_page.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in v_route_page.id=1
     *  - update:    v_route_page.update({id:1,KEY:VALUE})    update von KEY:VALUE in v_route_page.id=1
     *  - delete:    v_route_page.remove({id:1})              löscht v_route_page.id=1
     *               v_route_page.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function v_route_page ($resource) {
        return $resource('/api/v2/db/_table/v_route_page/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name v_route_page.get
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_route_page.get() Datenbank-Selection der Tabelle v_route_page
            ...
            /**
             * @ngdoc function
             * @name v_route_page.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_route_page.create() erstellt eine Instanz des Entity-Typs v_route_page
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created v_route_page instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/v_route_page/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name v_route_page.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_route_page.replace() ersetzen von einzelen Feldern einer Instanz des Typs v_route_page
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name v_route_page.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_route_page.update() update von einzelen Feldern einer Instanz des Typs v_route_page
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name v_route_page.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * v_route_page.remove() löschen einer Instanz des Typs v_route_page
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
