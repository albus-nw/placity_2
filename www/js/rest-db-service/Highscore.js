...
angular.module('restDataServices')
    .factory('Highscore', Highscore);

    Highscore.$inject = ['$resource'];
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen Highscore
     *
     * @example:
     *  - get:       Highscore.get({id:'1',related:'*'})   selectiert Highscore mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    Highscore.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   Highscore.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in Highscore.id=1
     *  - update:    Highscore.update({id:1,KEY:VALUE})    update von KEY:VALUE in Highscore.id=1
     *  - delete:    Highscore.remove({id:1})              löscht Highscore.id=1
     ...
     */
        ...
        return $resource('/api/v2/db/_table/Highscore/:id', {id: '@id'}, {
             ...
             *
             * @description
             * Highscore.get() Datenbank-Selection der Tabelle Highscore
            ...
            /**
             * @ngdoc function
             * @name Highscore.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Highscore.create() erstellt eine Instanz des Entity-Typs Highscore
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created Highscore instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/Highscore/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name Highscore.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Highscore.replace() ersetzen von einzelen Feldern einer Instanz des Typs Highscore
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name Highscore.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Highscore.update() update von einzelen Feldern einer Instanz des Typs Highscore
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name Highscore.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * Highscore.remove() löschen einer Instanz des Typs Highscore
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
