...
angular.module('restDataServices')
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen Route
     *
     * @example:
     *  - get:       Route.get({id:'1',related:'*'})   selectiert Route mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    Route.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   Route.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in Route.id=1
     *  - update:    Route.update({id:1,KEY:VALUE})    update von KEY:VALUE in Route.id=1
     *  - delete:    Route.remove({id:1})              löscht Route.id=1
     *               Route.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function Route ($resource) {
        return $resource('/api/v2/_table/Route/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name Route.get
             ...
             *
             * @description
             * Route.get() Datenbank-Selection der Tabelle Route
             ...
             *
             * @description
             * Route.create() erstellt eine Instanz des Entity-Typs Route
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created Route instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/Route/create'
             ...
             *
             * @description
             * Route.replace() ersetzen von einzelen Feldern einer Instanz des Typs Route
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @description
             * Route.update() update von einzelen Feldern einer Instanz des Typs Route
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @description
             * Route.remove() löschen einer Instanz des Typs Route
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
