...
angular.module('restDataServices')
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen Address
     *
     * @example:
     *  - get:       Address.get({id:'1',related:'*'})   selectiert Address mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    Address.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   Address.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in Address.id=1
     *  - update:    Address.update({id:1,KEY:VALUE})    update von KEY:VALUE in Address.id=1
     *  - delete:    Address.remove({id:1})              löscht Address.id=1
     *               Address.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function Address ($resource) {
        return $resource('/api/v2/db/_table/Address/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name Address.get
             ...
             *
             * @description
             * Address.get() Datenbank-Selection der Tabelle Address
             ...
             *
             * @description
             * Address.create() erstellt eine Instanz des Entity-Typs Address
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created Address instance
             */
            create: {
                method: 'POST'
             ...
             *
             * @description
             * Address.replace() ersetzen von einzelen Feldern einer Instanz des Typs Address
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @description
             * Address.update() update von einzelen Feldern einer Instanz des Typs Address
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @description
             * Address.remove() löschen einer Instanz des Typs Address
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
