...
angular.module('restDataServices')
    .factory('FileSharedForGroup', FileSharedForGroup);

    FileSharedForGroup.$inject = ['$resource'];

    /* @ngInject */
    /**
     * @ngdoc service
     * @name FileSharedForGroup
     * @requires $resource
     * @requires ngResource
     *
     ...
     *
     *  * ---
     * CRUD - Operationen via REST-Schnittstelle für den Entitytypen FileSharedForGroup
     *
     * @example:
     *  - get:       FileSharedForGroup.get({id:'1',related:'*'})   selectiert FileSharedForGroup mit id=1 und führt alle Fremdschlüssel
     *                                                  Assoziationen an.
     *  - create:    FileSharedForGroup.get({Key:VALUE})            erstellt einen neuen Eintrag mit Key:VALUE
     *                                                  Rückgabe: ID
     *  - replace:   FileSharedForGroup.replace({id:1,KEY:VALUE})   ersetzt KEY:VALUE in FileSharedForGroup.id=1
     *  - update:    FileSharedForGroup.update({id:1,KEY:VALUE})    update von KEY:VALUE in FileSharedForGroup.id=1
     *  - delete:    FileSharedForGroup.remove({id:1})              löscht FileSharedForGroup.id=1
     *               FileSharedForGroup.remove({filter:'id>2'})     löscht alle Einträge mit ID > 2
     */
        function FileSharedForGroup ($resource) {
        return $resource('/api/v2/db/_table/FileSharedForGroup/:id', {id: '@id'}, {
            /**
             * @ngdoc function
             * @name FileSharedForGroup.get
             * @module RestDataServices
             * @kind function
             *
             * @description
             * FileSharedForGroup.get() Datenbank-Selection der Tabelle FileSharedForGroup
            ...
            /**
             * @ngdoc function
             * @name FileSharedForGroup.create
             * @module RestDataServices
             * @kind function
             *
             * @description
             * FileSharedForGroup.create() erstellt eine Instanz des Entity-Typs FileSharedForGroup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
             ...
             *
             * @returns {integer} id of created FileSharedForGroup instance
             */
            create: {
                method: 'POST'
                // url: '/api/v2/FileSharedForGroup/create'
                // You can provide different urls for different CRUD operations
            },
            /**
             * @ngdoc function
             * @name FileSharedForGroup.replace
             * @module RestDataServices
             * @kind function
             *
             * @description
             * FileSharedForGroup.replace() ersetzen von einzelen Feldern einer Instanz des Typs FileSharedForGroup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name FileSharedForGroup.update
             * @module RestDataServices
             * @kind function
             *
             * @description
             * FileSharedForGroup.update() update von einzelen Feldern einer Instanz des Typs FileSharedForGroup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            /**
             * @ngdoc function
             * @name FileSharedForGroup.remove
             * @module RestDataServices
             * @kind function
             *
             * @description
             * FileSharedForGroup.remove() löschen einer Instanz des Typs FileSharedForGroup
             * siehe [APIDocs](http://df.albus-it.com/dreamfactory/dist/index.html#/apidocs)
             *
             * @param
             *  {
            ...
            //    return FileSharedForGroup.create();
            //}
        })
    }
